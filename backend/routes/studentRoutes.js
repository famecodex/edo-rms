...
// Get single student by ID (put specific routes before general ones)
router.get("/:id", protect, authorizeRoles("student", "teacher", "principal", "ministry"), getStudentById);
